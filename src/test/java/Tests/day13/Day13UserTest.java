...
class Day13UserTest {
    ...
    void isSubscribedTrue() {
        ...
        User b = new User("b");
        a.subscribe(b);
        Assertions.assertTrue(a.isSubscribe(b), "Пользователь 1 подписан на пользователя 2?");
    }
    ...
    void isSubscribedFalse() {
        User a = new User("a");
        User b = new User("b");
        Assertions.assertFalse(a.isSubscribe(b), "Пользователь 1 не подписан на пользователя 2?");
    }
